Public Class Form1
    Private Sub Btn_Calcular_Click(sender As Object, e As EventArgs) Handles Btn_Calcular.Click
        ...
        'Sección de código donde se válida que no existan datos igual a 0

        If Val(Txt_Monto1.Text) = 0 Then
            If Val(Txt_Monto2.Text) = 0 Then
                If Val(Txt_Monto3.Text) = 0 Then
                    If Val(Txt_SaldoAnt.Text) = 0 Then

                        MsgBox("Ingrese otro valor distinto de cero", vbExclamation, Title:="Error")
